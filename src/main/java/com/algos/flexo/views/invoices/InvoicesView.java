package com.algos.flexo.views.invoices;
...
@Route(value = "fatture", layout = MainView.class)
@PageTitle(Application.APP_NAME + " | Fatture")
@PageSubtitle("Fatture")
@CssImport(value = "./views/invoices/invoices-view.css")
...
//        });
    ...
    private void createGrid(){
        ...
        CallbackDataProvider<Invoice, Void> provider;
...
//                List<Invoice> entities = marketIndexService.fetch(offset, limit, indexFilter, order);
...
//        dialog.open();
    ...
    private HorizontalLayout createCard(Invoice model) {
