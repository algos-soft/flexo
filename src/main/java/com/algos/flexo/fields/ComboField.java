package com.algos.flexo.fields;
...
public class ComboField<T>  extends CustomField<T> {
     ...
     * L' istanza viene costruita con appContext.getBean(AComboField.class) <br>
     */
    public ComboField() {
     ...
     */
    public ComboField(List<String> items) {
        this(items, true);
    } // end of SpringBoot constructor
     ...
     */
    public ComboField(List<String> items, boolean isRequired) {
     ...
     */
    public ComboField(List<String> items, boolean isRequired, boolean isAllowCustomValue) {
